...
module RoutingLib.Routing.Algorithms.DistributedBellmanFord.Convergence.Proof where
  ...
  module WithoutPaths
    ...
    open import SimilarityConvergenceProof.WithoutPaths.Step1_HeightFunction rp cc using (heightFunction)
    open import SimilarityConvergenceProof.WithoutPaths.Step2_Ultrametric rp cc heightFunction using (d-metric)
    open import SimilarityConvergenceProof.WithoutPaths.Step3_SimilarityIncreasing rp cc heightFunction using (σ-strictlyContractingOnOrbits)
