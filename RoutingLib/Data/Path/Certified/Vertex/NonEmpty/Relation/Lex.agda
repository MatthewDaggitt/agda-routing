...
open import Data.Nat.Properties using (<⇒≯; 1+n≰n; <-trans; <-cmp)
...
open import RoutingLib.Data.Path.NonEmpty
...
module RoutingLib.Data.Path.NonEmpty.Relation.Lex where

  -- Lexicographic order
  infix 4 _≤ₗₑₓ_
  data _≤ₗₑₓ_  : Rel Pathⁿᵗ ℓ₀ where
    stop  : ∀ {p} → [] ≤ₗₑₓ p
