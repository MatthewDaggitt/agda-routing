...
open import RoutingLib.Data.Path.EdgePath.NonEmpty using ([]; length)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Properties using (length-cong)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Relation.Lex
...
≈ᵣ-refl {valid l cs p} = validEq refl ≈ᶜˢ-refl ≈ₚ-refl
...
≤ᵣ-refl {valid l cs p} = comm≤ refl ≈ₚ-refl ≤ᶜˢ-refl
