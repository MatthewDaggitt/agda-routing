...
module RoutingLib.Data.Matrix.Relation.Binary.Equality {a ℓ} (S : Setoid a ℓ) where
...
open import RoutingLib.Data.Matrix.Relation.Binary.Pointwise as PW using (Pointwise)
