...
open import Relation.Binary.PropositionalEquality using (_≡_; _≢_; refl; sym; trans; subst; cong; cong₂; module ≡-Reasoning)
...
module RoutingLib.Data.Nat.Properties where
  ...
  abstract
    ...
    +-monoₗ-< : _+_ Preserves₂ _<_ ⟶ _≤_ ⟶ _<_
    +-monoₗ-< {_} {suc y} (s≤s z≤n)       u≤v = s≤s (≤-steps y u≤v)
    +-monoₗ-< {_} {_}     (s≤s (s≤s x<y)) u≤v = s≤s (+-monoₗ-< (s≤s x<y) u≤v)

    +-monoᵣ-< : _+_ Preserves₂ _≤_ ⟶ _<_ ⟶ _<_
    +-monoᵣ-< {x} {y} {u} {v} x≤y u<v rewrite +-comm x u | +-comm y v = +-monoₗ-< u<v x≤y
    ...
    1+m≤n⇒m≤n zero    (s≤s z≤n)       = z≤n
    1+m≤n⇒m≤n (suc m) (s≤s (s≤s m≤n)) = s≤s (≤-step m≤n)
    
    m+n≤o⇒n≤o : ∀ m {n o} → m + n ≤ o → n ≤ o
    m+n≤o⇒n≤o zero    n≤o   = n≤o
    m+n≤o⇒n≤o (suc m) m+n≤o = m+n≤o⇒n≤o m (1+m≤n⇒m≤n (m + _) m+n≤o)
  ...
  -}
    ...
    m+o≡n⇒m≡n∸o : ∀ {m n o} → m + o ≡ n → m ≡ n ∸ o
    m+o≡n⇒m≡n∸o {m} {n} {o} refl =
      begin
        m           ≡⟨ sym (+-right-identity m) ⟩
        m + 0       ≡⟨ sym (cong (m +_) (n∸n≡0 o)) ⟩
        m + (o ∸ o) ≡⟨ sym (+-∸-assoc m (≤-refl {o})) ⟩
        m + o ∸ o
      ∎
      where open ≡-Reasoning
    ...
    m+o≤n⇒m≤n∸o {m} {n} {o} m+o≤n =
      begin
        ...
        m + 0       ≡⟨ sym (cong (m +_) (n∸n≡0 o)) ⟩
        m + (o ∸ o) ≡⟨ sym (+-∸-assoc m (≤-refl {o})) ⟩
        m + o ∸ o   ≤⟨ ∸-monoᵣ-≤ m+o≤n (m+n≤o⇒n≤o m m+o≤n) ⟩
        n ∸ o
      ∎
      where open ≤-Reasoning
