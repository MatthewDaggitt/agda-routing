...
open import RoutingLib.Data.Path.EdgePath
  using (Path; invalid; valid)
open import RoutingLib.Data.Path.EdgePath.Relation.Equality hiding (≈ₚ-reflexive; ≈ₚ-sym; p≉i∷p)
open import RoutingLib.Data.Path.EdgePath.NonEmpty
  using (Pathⁿᵗ; []; _∷_∣_∣_; length; _⇿_; _∉_; _∈_)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Relation.Equality using (≈ₚ-sym; p≉i∷p; ≈ₚ-reflexive)
