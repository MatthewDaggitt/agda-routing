...
module RoutingLib.Routing.BellmanFord.GeneralConvergence.Step2_UltrametricAlt
  {a b ℓ n-1}
  ...
  abstract
    ...
    dₛᵤₚ∸hXᵢⱼ≤d {X} {Y} Xᵢⱼ≉Yᵢⱼ = ≤ℕ-trans (dₛᵤₚ∸hx≤dₑ Xᵢⱼ≉Yᵢⱼ) (dₑ≤d X Y _ _)
    ...
    ... | i , j , d≡dₑ = contradiction (≡-trans (≡-sym d≡dₑ) d≡1) (dₑ≢1 (X i j) (Y i j))
