...
import RoutingLib.Data.Path.EdgePath.NonEmpty.All as NEP

module RoutingLib.Data.Path.EdgePath.All where
  ...
  allₑ? : ∀ {a} {P : Pred Edge a} → Decidable P → Decidable (Allₑ P)
