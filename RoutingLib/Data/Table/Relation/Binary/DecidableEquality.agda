...
module RoutingLib.Data.Table.Relation.Binary.DecidableEquality
...
open import RoutingLib.Data.Table.Relation.Binary.Pointwise
  using () renaming (decSetoid to pointwiseDecSetoid)

open DecSetoid DS using (_≈_; _≟_) renaming (setoid to S; Carrier to A)
open import RoutingLib.Data.Table.Relation.Binary.Equality S public
