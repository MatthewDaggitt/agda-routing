...
open import Data.Fin using (Fin; _≤?_; suc; zero; toℕ; fromℕ≤)
open import Data.Fin.Properties using (cmp; ≤-antisym; ≤-total; _<?_; toℕ-fromℕ≤)
...
open import RoutingLib.Data.Path.EdgePath
open import RoutingLib.Data.Path.EdgePath.Relation.Equality
open import RoutingLib.Data.Path.EdgePath.NonEmpty as NE using (Pathⁿᵗ)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Properties as NEP using ()
open import RoutingLib.Data.Nat.Properties using (n≢1+n)

module RoutingLib.Data.Path.EdgePath.Properties where
