...
open import RoutingLib.Data.Graph.EPath using (EPath; [_]; _∷_∣_; _≤ₗ_; _≤ₚ_; _≈ₚ_; _≉ₚ_; _∉?_; source)
open import RoutingLib.Data.Graph.EPath.Properties

module RoutingLib.Routing.AddingPaths.Inconsistent.Properties
  ...
  open import RoutingLib.Routing.AddingPaths.Inconsistent ra ⊕-sel one G
  ...
  abstract
    ...
    ...   | yes p≤q | yes q≤p = irouteEq (trans (sym x⊕y≈x) x⊕y≈y) (≤ₗₚ-antisym p≤q q≤p)
    ...   | yes _   | no  _   = ≈ⁱ-refl
    ...   | no  _   | yes _   = ≈ⁱ-refl
