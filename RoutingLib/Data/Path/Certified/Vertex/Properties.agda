...
open import RoutingLib.Data.Path.NonEmpty as NE using (Pathⁿᵗ)
open import RoutingLib.Data.Path.NonEmpty.Properties as NEP using ()
open import RoutingLib.Data.Nat.Properties using (n≢1+n)

module RoutingLib.Data.Path.Properties where
