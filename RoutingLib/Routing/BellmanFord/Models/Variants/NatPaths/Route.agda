...
open import RoutingLib.Data.Path.EdgePath.NonEmpty using (Pathⁿᵗ; length)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Relation.Equality using (_≈ₚ_)
open import RoutingLib.Data.Path.EdgePath.NonEmpty.Relation.Lex using (_<ₗₑₓ_)
{-
...
data Route : Set where
  invalid : Route
  valid   : (l : ℕ) → (cs : CommunitySet) → (p : Pathⁿᵗ) → Route
