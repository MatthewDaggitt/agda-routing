...
map-†-lemma {[]} {f} = ↭-refl
map-†-lemma {(d , v) ∷ xs} {f} with IsValid? (d , v)
... | no invalid  = p
...
[]-cong A=A' = †-cong (lemma A=A')
   where lemma : {A A' : RoutingSet} → {f : Route → Route} →
         ...
         lemma (prep (d=d' , v=v') A=A') = prep (d=d' , f-cong _ v=v') (lemma A=A')
         lemma (swap (d₁=d₁' , v₁=v₁') (d₂=d₂' , v₂=v₂')  A=A') =
                 swap (d₁=d₁' , f-cong _ v₁=v₁') (d₂=d₂' , f-cong _ v₂=v₂') (lemma A=A')
